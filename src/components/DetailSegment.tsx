...
import useNearConnection from '../adapters/near-connection/useNearConnection'
...
export const DetailSegment: FC<DetailSegmentProps> = ({
  name,
  onChangeName,
  loading,
}) => {
  ...
  const { signIn, wallet, isSignedIn, signOut } = useNearWallet()
      ...
      <div className="w-full h-full p-4 flex flex-col justify-start items-left">
        ...
        <div className="flex flex-col justify-between items-center py-4 px-4 mt-12">
          {showChangeNameInput ? (
            ...
            <div
              className="text-lg font-semibold my-8"
